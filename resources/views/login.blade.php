...
<html>
  <head>
    ...
    <title>Login - Finpersonnel</title>
  </head>
  <body>
      ...
      <div class="login-box">
          ...
          <div class="form-group">
            <div class="utility">
              <div class="animated-checkbox">
                <label>
                  <input type="checkbox"><span class="label-text">Rester Connnecté</span>
                </label>
              </div>
        ...
        <form class="forget-form" action="index.html">
          ...
          <div class="form-group mt-3">
            <p class="semibold-text mb-0"><a href="#" data-toggle="flip"><i class="fa fa-angle-left fa-fw"></i>Retourné pour Login</a></p>
          </div>
        </form>
      </div>
    </section>
